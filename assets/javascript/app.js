$(document).ready(function(){
    ...
    $(document).on("click","#search", function () {
        ...
        $.ajax({
            ...
            $('#videoId1').attr('src', "https://www.youtube.com/embed/" + videoId1 )
            var videoId2 = response.items[0].id.videoId
            $('#videoId2').attr('src', "https://www.youtube.com/embed/" + videoId2 )
            var videoId2 = response.items[0].id.videoId
            $('#videoId3').attr('src', "https://www.youtube.com/embed/" + videoId3 )
